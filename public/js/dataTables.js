...
(function (f) { "function" === typeof define && define.amd ? define(["jquery"], function (z) { return f(z, window, document) }) : "object" === typeof exports ? module.exports = function (z, y) { z || (z = window); y || (y = "undefined" !== typeof window ? require("jquery") : require("jquery")(z)); return f(y, z, z.document) } : f(jQuery, window, document) })(function (f, z, y, p) {
    function H(a) {
        ...
        if (!q.__browser) {
            var b = {}; q.__browser = b; var c = f("<div/>").css({
                ...
                overflow: "hidden"
            }).append(f("<div/>").css({ position: "absolute", top: 1, left: 1, width: 100, overflow: "scroll" }).append(f("<div/>").css({ width: "100%", height: 5 }))).appendTo("body"), d = c.children(), e = d.children(); b.barWidth = d[0].offsetWidth - d[0].clientWidth; b.bScrollOversize = 100 === e[0].offsetWidth && 100 !== d[0].clientWidth; b.bScrollbarLeft = 1 !== Math.round(e.offset().left); b.bBounding = c[0].getBoundingClientRect().width ? !0 : !1; c.remove()
    ...
    function ua(a, b, c) { var d = []; c || (c = a.aoHeader, b && (c = [], fa(c, b))); b = 0; for (var e = c.length; b < e; b++)for (var h = 0, g = c[b].length; h < g; h++)!c[b][h].unique || d[h] && a.bSortCellsTop || (d[h] = c[b][h].cell); return d } function va(a, b, c) {
        ...
        var c = function (a, c) { return b[a] !== p ? b[a] : b[c] }, d = wa(a, b), e = c("sEcho", "draw"), h = c("iTotalRecords",
            "recordsTotal"); c = c("iTotalDisplayRecords", "recordsFiltered"); if (e) { if (1 * e < a.iDraw) return; a.iDraw = 1 * e } qa(a); a._iRecordsTotal = parseInt(h, 5); a._iRecordsDisplay = parseInt(c, 5); e = 0; for (h = d.length; e < h; e++)R(a, d[e]); a.aiDisplay = a.aiDisplayMaster.slice(); a.bAjaxDataGet = !1; S(a); a._bInitComplete || xa(a, b); a.bAjaxDataGet = !0; K(a, !1)
        ...
        c, d) { a = b ? a : Ua(a); c && (a = "^(?=.*?" + f.map(a.match(/"[^"]+"|[^ ]+/g) || [""], function (a) { if ('"' === a.charAt(0)) { var b = a.match(/^"(.*)"$/); a = b ? b[1] : a } return a.replace('"', "") }).join(")(?=.*?") + ").*$"); return new RegExp(a, d ? "i" : "") } function Eb(a) {
            ...
            a._bInitComplete = !0; (b || a.oInit.aaData) && aa(a); A(a, null, "plugin-init", [a, b]); A(a, "aoInitComplete", "init",
                [a, b])
        } function Va(a, b) { b = parseInt(b, 5); a._iDisplayLength = b; Wa(a); A(a, null, "length", [a, b]) } function tb(a) {
            ...
            var d = a._iDisplayStart, e = a._iDisplayLength, h = a.fnRecordsDisplay(); 0 === h || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > h && (d = 0)) : "หน้าแรก" == b ? d = 0 : "ก่อนหน้า" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "ถัดไป" == b ? d + e < h && (d += e) : "หน้าสุดท้าย" == b ? d = Math.floor((h - 1) / e) * e : O(a, 0, "Unknown paging action: " + b, 5); b =
        ...
        "row().remove()", function () {
            ...
            var d = a.aoColumns, e = J(d, "sName"), h = J(d, "nTh"); return eb("column", b, function (b) {
                var g = Sb(b); if ("" === b) return Z(d.length); if (null !==
                    g) return [0 <= g ? g : d.length + g]; if ("function" === typeof b) { var l = Fa(a, c); return f.map(d, function (c, d) { return b(d, Zb(a, d, 0, 0, l), h[d]) ? d : null }) } var n = "string" === typeof b ? b.match(jc) : ""; if (n) switch (n[2]) { case "visIdx": case "visible": g = parseInt(n[1], 5); if (0 > g) { var m = f.map(d, function (a, b) { return a.bVisible ? b : null }); return [m[m.length + g]] } return [ba(a, g)]; case "name": return f.map(e, function (a, b) { return a === n[1] ? b : null }); default: return [] }if (b.nodeName && b._DT_CellIndex) return [b._DT_CellIndex.column]; g = f(h).filter(b).map(function () {
    ...
    q.version = "1.5.20"; q.settings = []; q.models = {}; q.models.oSearch = { bCaseInsensitive: !0, sSearch: "", bRegex: !1, bSmart: !0 }; q.models.oRow = { nTr: null, anCells: null, _aData: [], _aSortData: null, _aFilterData: null, _sFilterRow: null, _sRowStripe: "", src: null, idx: -1 }; q.models.oColumn = {
        ...
        fnStateLoadParams: null, fnStateLoaded: null, fnStateSaveCallback: function (a, b) { try { (-1 === a.iStateDuration ? sessionStorage : localStorage).setItem("DataTables_" + a.sInstance + "_" + location.pathname, JSON.stringify(b)) } catch (c) { } }, fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 5, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {
            oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: {
                sFirst: "หน้าแรก", sLast: "หน้าสุดท้าย",
                sNext: "ถัดไป", sPrevious: "ก่อนหน้า"
            }, sEmptyTable: "ไม่พบข้อมูล", sInfo: "แสดง _START_ ถึง _END_ ของ _TOTAL_ รายการ", sInfoEmpty: "แสดง 0 ถึง 0 ของ 0 รายการ", sInfoFiltered: "(กรองจาก _MAX_ รายการทั้งหมด)", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "แสดง _MENU_ รายการ", sLoadingRecords: "กำลังโหลด...", sProcessing: "กำลังประมวลผล...", sSearch: "สืบค้น:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "ไม่พบบันทึกที่ตรงกัน"
    ...
    }; H(q.defaults); q.defaults.column = { aDataSort: null, iDataSort: -1, asSorting: ["asc", "desc"], bSearchable: !0, bSortable: !0, bVisible: !0, fnCreatedCell: null, mData: null, mRender: null, sCellType: "td", sClass: "", sContentPadding: "", sDefaultContent: null, sName: "", sSortDataType: "std", sTitle: null, sType: null, sWidth: null }; H(q.defaults.column); q.models.oSettings =
    {
        ...
        aoStateSave: [], aoStateLoad: [], oSavedState: null, oLoadedState: null, sAjaxSource: null, sAjaxDataProp: null, bAjaxDataGet: !0, jqXHR: null, json: p, oAjaxData: p, fnServerData: null, aoServerParams: [], sServerMethod: null, fnFormatNumber: null, aLengthMenu: null, iDraw: 0, bDrawing: !1, iDrawError: -1, _iDisplayLength: 5, _iDisplayStart: 0, _iRecordsTotal: 0, _iRecordsDisplay: 0, oClasses: {}, bFiltered: !1, bSorted: !1, bSortCellsTop: null, oInit: null, aoDestroyCallback: [], fnRecordsTotal: function () {
    ...
    f.extend(q.ext.classes, {
    ...
    }); var Pb = q.ext.pager; f.extend(Pb, { simple: function (a, b) { return ["ก่อนหน้า", "ถัดไป"] }, full: function (a, b) { return ["หน้าแรก", "ก่อนหน้า", "ถัดไป", "หน้าสุดท้าย"] }, numbers: function (a, b) { return [ka(a, b)] }, simple_numbers: function (a, b) { return ["ก่อนหน้า", ka(a, b), "ถัดไป"] }, full_numbers: function (a, b) { return ["หน้าแรก", "ก่อนหน้า", ka(a, b), "ถัดไป", "หน้าสุดท้าย"] }, first_last_numbers: function (a, b) { return ["หน้าแรก", ka(a, b), "หน้าสุดท้าย"] }, _numbers: ka, numbers_length: 7 }); f.extend(!0, q.ext.renderer, {
        pageButton: {
            _: function (a, b,
                c, d, e, h) {
                    ...
                    var p, r = g.sPageButtonDisabled, u = function (b) { Xa(a, b.data.action, !0) }; var w = 0; for (p = d.length; w < p; w++) {
                        var v = d[w]; if (f.isArray(v)) { var x = f("<" + (v.DT_el || "div") + "/>").appendTo(b); t(x, v) } else {
                            n = null; m = v; x = a.iTabIndex; switch (v) {
                                case "ellipsis": b.append('<span class="ellipsis">&#x2026;</span>'); break; case "หน้าแรก": n = k.sFirst; 0 === e && (x = -1, m += " " + r); break; case "ก่อนหน้า": n = k.sPrevious; 0 === e && (x = -1, m +=
                                    " " + r); break; case "ถัดไป": n = k.sNext; e === h - 1 && (x = -1, m += " " + r); break; case "หน้าสุดท้าย": n = k.sLast; e === h - 1 && (x = -1, m += " " + r); break; default: n = v + 1, m = e === v ? g.sPageButtonActive : ""
        ...
        number: function (a, b, c, d, e) {
            return {
                display: function (f) {
                    if ("number" !== typeof f && "string" !== typeof f) return f; var g = 0 > f ? "-" : "", h = parseFloat(f); if (isNaN(h)) return ib(f); h = h.toFixed(c); f = Math.abs(h); h = parseInt(f, 5); f = c ? b + (f - h).toFixed(c).substring(2) : ""; return g + (d || "") + h.toString().replace(/\B(?=(\d{3})+(?!\d))/g,
                        a) + f + (e || "")
                }
            }
