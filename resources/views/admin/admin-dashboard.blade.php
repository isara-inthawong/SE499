        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <span class="pull-right clickable panel-toggle panel-button-tab-left">
                    ...
                    <em class="fas fa-toggle-on" id="myDIV" onclick="myFunction()"></em>
...
<div class="row">
    <div class="col-md-6">
                ...
                <ul>
                    <li class="left clearfix"><span class="chat-img pull-left">
                        ...
                        <div class="chat-body clearfix">
                            <div class="header"><strong class="primary-font">Jane Doe</strong> <small
                                    class="text-muted">32 mins ago</small></div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ante turpis, rutrum ut
                                ullamcorper sed, dapibus ac nunc.</p>
                        </div>
                    </li>
                    <li class="right clearfix"><span class="chat-img pull-right">
                        ...
                        <div class="chat-body clearfix">
                            <div class="header"><strong class="pull-left primary-font">John Doe</strong> <small
                                    class="text-muted">6 mins ago</small></div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ante turpis, rutrum ut
                                ullamcorper sed, dapibus ac nunc.</p>
                        </div>
                    </li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                <div class="input-group">
                    <input id="btn-input" type="text" class="form-control input-md" placeholder="Add new task" /><span
                    ...
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer at sodales nisl.
                                    Donec malesuada orci ornare risus finibus feugiat.</p>
                            </div>
                        </div>
                    </li>
                    <li>
